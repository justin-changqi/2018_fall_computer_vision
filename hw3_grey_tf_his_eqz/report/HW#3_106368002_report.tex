...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\begin{reportsection}{-1cm}{-1cm}
      ...
      transform curve and output images. (Figure, 20\%; Discussion, 10\%)
        ...
        % \end{tikzpicture}
    \subsection*{Ans}
    The concept of \textbf{Piecewise-Linear transformation} is use pre-define Gamma function
    to transform, Equation~(\ref{eqr:gamma-func}) the pixel value.
    \begin{equation}
      s_{r}=c \cdot r^{\gamma}
      \label{eqr:gamma-func}
    \end{equation}
    Figure~\ref{fig:power-law-curve} shows the curves for difference Gamma value apply to 
    Gamma function.
    \begin{figure}[h]
      \centering
    ...
    \end{figure}
    \newpage
    The best gamma for cat\_bright.raw is \textbf{10.0}. According to  Figure~\ref{fig:power-law-curve}, 
    the high pixel value apply Gamma=10 curve is more sensitive.
		\begin{figure}[htbp]
			\centering
			...
			\label{fig:power-law-bright}
    \end{figure}
    \vspace{3em}

    The best gamma for cat\_dark.raw is \textbf{0.2}. For enhancing dark image the gamma value need to
    < 1 to make it sensitive on low pixel value.  
    \begin{figure}[htbp]
			\centering
			\begin{subfigure}[b!]{0.43\linewidth}
      ...
      \label{fig:power-law-dark}
    \end{figure}
    
    \newpage
    In \textbf{Piecewise-Linear transformation} method, we define our linear curve by self, so in 
    Figure~\ref{fig:piec-b-curve} I define a curve for scale high grey level pixel value for bright image. 
    The enhance result of cat\_bright.raw shows on Figure~\ref{fig:piec-b}. The best values $(r_{1}, s_{1})=(20, 10)$ and 
    $(r_{2}, s_{2})=(150,50)$.
    ...
    \end{figure}
    \newpage
    Figure~\ref{fig:piec-d-curve}, I define a linear curve for scale low gray-level value. The best 
    values $(r_{1}, s_{1})=(10, 150)$ and $(r_{2}, s_{2})=(50,200)$.
    \begin{figure}[htbp]
      \centering
    ...
    \begin{enumerate}[label=\alph*.]
        ...
        \subsection*{Ans}
        The difference between bright and dark image histogram are distributed on different
        mean and variance. For example, the histogram of bright image, The most pixel are locate 
        in high value area (see Figure~\ref{fig:his-b}). On the other, dark image pixel value are 
        concentrate on low value part (see Figure~\ref{fig:his-d}). 
        \begin{figure}[htbp]
          \centering
          ...
          \begin{subfigure}[b!]{0.46\linewidth}
            ...
            \label{fig:his-d}
          \end{subfigure}
          \caption{Histofram of living room images}
          \label{fig:his}
        \end{figure}
      \item  
        ...
        \subsection*{Ans}
          The result of bright and dark living room images show on Figure~\ref{fig:his-eq}. 
          We can see after histogram equalization, both of dark and bright are get the same 
      ...
      \item  
        ...
        \subsection*{Ans}
        In Figure~\ref{fig:his-eq-b-img} and Figure~\ref{fig:his-eq-d-img} are the images which
        is performed histogram equalization. The result images looks very similar. In the result images,
        we can see there are some false contouring effect. For solving this problem, we can thought 
        low-pass to make images more smooth. 
        \begin{figure}[htbp]
          \centering
          \begin{subfigure}[b!]{0.40\linewidth}
            \includegraphics[width=\textwidth]{{"../result_img/problem2/livingroom_bright_src"}.png}
            \caption{Original bright image.}
          \end{subfigure}
          \hspace{1em}
          \begin{subfigure}[b!]{0.40\linewidth}
          ...
          \end{subfigure}
          \caption{Living room bright histogram equalization}
          \label{fig:his-eq-b-img}
        \end{figure}
        ...
        \begin{figure}[htbp]
          ...
          \begin{subfigure}[b!]{0.40\linewidth}
            ...
            \caption{Equalize image.}
          \end{subfigure}
          \caption{Living room dark histogram equalization}
          \label{fig:his-eq-d-img}
        \end{figure}
    \end{enumerate}
    \newpage
